...
- **Trunk 8.0** (pharmacology firewall): `trunk/trunk-8.0-stub-agent.js` — `npm run trunk:stub:8`
- **Trunk 9.0** (red-flag questionnaire): `trunk/trunk-9.0-stub-agent.js` — `npm run trunk:stub:9`
